        ...
        return (
          ...
          >
            ...
            <div className="flex gap-1 shrink-0">
              ...
              <Button variant="ghost" size="sm" onClick={() => setConfirmDelete(session.id)}>Suppr.</Button>
            </div>
          </div>
        )
      })}
      ...
      {confirmDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm p-4" onClick={() => setConfirmDelete(null)}>
          <div className="bg-surface-card rounded-2xl border border-border shadow-xl p-6 max-w-sm w-full" onClick={e => e.stopPropagation()}>
            ...
            <h3 className="text-center text-sm font-semibold text-text-primary mb-1">Supprimer cette séance ?</h3>
            <p className="text-center text-xs text-text-muted mb-5">Cette action est irréversible.</p>
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex-1 px-3 py-2 text-sm font-medium text-white bg-red-500 rounded-xl
