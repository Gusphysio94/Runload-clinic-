                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        <button
                          ...
                          className="p-1.5 rounded-lg text-text-muted hover:text-text-primary hover:bg-surface-dark/30 transition-colors"
                          title="Modifier"
                        >
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-lg text-text-muted hover:text-amber-500 hover:bg-amber-50 transition-colors"
                          title="Retirer"
                        >
                          <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    ...
                    <div className="mt-2 flex items-center gap-2">
                      <button
                        ...
                        className="text-[0.65rem] px-2 py-1 rounded-lg border border-border/40 text-text-muted hover:text-text-primary hover:bg-surface-dark/20 transition-colors"
                      >
                        +5 km
                      </button>
                      <button
